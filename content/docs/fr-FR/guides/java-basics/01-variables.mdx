...
Parfois, vous ne voudriez pas qu'une variable reste du même type Vous pouvez faire des conversions entre les types : Vous pouvez faire des conversions entre les types :
