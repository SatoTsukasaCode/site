...
<Callout type="Información" title="El orden de los parámetros importa">
...
<Callout type="advertencia" title="Retornar Detiene la Ejecución">
...
<Callout type="Información" title="Reglas de la sobrecarga de métodos">
...
<Callout type="información" title="Nombramiento de los métodos">
