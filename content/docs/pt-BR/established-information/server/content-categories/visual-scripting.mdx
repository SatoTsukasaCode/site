...
description: Por enquanto, uma introdução ao que sabemos sobre o sistema de programação visual de Hytale da redação desse artigo.
---

# Programação Visual

A Hytale planeja apoiar o Visual Scripting como um método para tornar a lógica avançada e o fluxo de controle acessíveis a um público mais amplo. Este sistema não estará disponível no lançamento, mas deve estar disponível logo após o lançamento.

## Visão geral

O sistema de script visual em Hytale foi projetado para funcionar de forma semelhante aos Blueprints na Unreal Engine. Ele permite que os designers criem comportamentos complexos por meio de uma interface visual que corresponda à forma como pensam sobre a lógica do jogo, sem precisar escrever código diretamente.

### Principais recursos

* **Subconjunto da Funcionalidade Java**: A Programação Visual oferece uma parte do recurso que se pode alcançar com plugins Java.
...
## Vantagens da programação tradicional
