...
description: Une introduction à ce que nous savons du système de scripting visuel d'Hytale au moment d'écrire cet article.
---

# Scripting visuel

Hytale prévoit de prendre en charge le Scripting visuel comme méthode pour rendre les flux de logique et de contrôle avancés accessibles à un public plus large. Ce système ne sera pas disponible au lancement du jeu, mais devrait être disponible peu de temps après,

## Aperçu 

Le Scripting visuel dans Hytale est conçu pour fonctionner de la même manière que les Plans dans Unreal Engine. Il permet aux concepteurs de créer des comportements complexes à travers une interface visuelle qui correspond à la façon dont ils pensent à la logique du jeu, sans avoir à écrire de code directement.
