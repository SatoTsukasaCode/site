...
<Callout type="info" title="Примітка">
  Наведена нижче інформація базується на висновках, якими поділився технічний директор Slikey 15 грудня 2025 року на сервері Hytale Discord. It provides an overview of the server code architecture and plugin capabilities.
